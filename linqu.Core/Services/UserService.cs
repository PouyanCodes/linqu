    ...
    public class UserService : IUserService
    {
        ...
        public List<UserDataViewModel> GetUsers()
        {
            return _context.Users.Where(u => u.IsActive).
                Select(u => new UserDataViewModel()
                {
                    userId = u.UserId,
        ...
        public User GetUserByEmail(string email, bool isActive = true)
        {
            return _context.Users.SingleOrDefault(u => u.Email == email && u.IsActive == isActive);
        }
        ...
        public UserInformationViewModel GetUserInformaionByEmail(string email, bool isActive = true)
        {
            var user = _context.Users.SingleOrDefault(u => u.Email == email && u.IsActive == isActive);
        ...
        public EditProfileViewModel GetUserDataForEditProfile(string email, bool isActive = true)
        {
            var user = _context.Users.SingleOrDefault(u => u.Email == email && u.IsActive == isActive);
            var userInfo = _context.UserInformation.Find(user.UserId);
        ...
        public int GetUserIdByEmail(string email, bool isActive = true)
        {
            return _context.Users.Single(u => u.Email == email && u.IsActive == isActive).UserId;
        }
        ...
        public string GetUserAvatarByEmail(string email, bool isActive = true)
        {
            return _context.Users.SingleOrDefault(u => u.Email == email && u.IsActive == isActive).UserAvatar;
        }
        ...
        public string GetFullNameByEmail(string email, bool isActive = true)
        {
            var userId = GetUserIdByEmail(email, isActive);
        ...
        public int GetUserRoleByEmail(string email, bool isActive = true)
        {
            var userId = _context.Users.SingleOrDefault(u => u.Email == email && u.IsActive == isActive).UserId;
            return _context.UserRoles.SingleOrDefault(u => u.UserId == userId).RoleId;
        }

        public bool IsEmailExist(string email, bool isActive = true)
        {
            return _context.Users.Any(u => u.Email == email && u.IsActive == isActive);
        }
        ...
        public bool CompareOldPassword(string email, string oldPassword, bool isActive = true)
        {
            return _context.Users.Any(u => u.Email == email && u.Password == oldPassword && u.IsActive == isActive);
        }
